...
\end{figure}
 ...
 \begin{table*}[h]
     ...
     &   Entities &  Unique Entities & World-Size (Grids)  & Route Length \\ \hline
       HCRC     & 11.93  & 8.125  &  11.93 (movement between entitles) & 9.75  \\ 
        SAIL  & 22   & 0   & 33.33 & 5.34 \\
        TTW &  62.6                          & 0 (with perfect perception)         & 100 (25 walkable) & 2.5 \\
         OSS  & 932                           & 365                                                                             & 5281 (1059.6 walkable) & 78.89  
     \end{tabular}
     }
...
\hline
Baseline                          & \multicolumn{5}{c|}{20.2}                                           \\ \hline
...
CGAEW + CBS                       & 61.03      & 66.04      & \textbf{66.95} & 57.26      & 55.74       \\ \hline
\end{tabular}}
...
\begin{tabular}{ll|l|l|l|l|l|l}
                       & \textbf{Instruction}                                                                                                  & \textbf{Baseline} & \textbf{CGA} & \textbf{CGAE} & \textbf{CGAEW} & \textbf{\begin{tabular}[c]{@{}l@{}}CGAEW\\ +ABS\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}CGAEW\\ +CBS\end{tabular}} \\ \cline{2-8} 
...
%(a.k.a.\ StreetView), 
(cf. \newcite{anderson2017vision}) for more accurate localization, that would improve action selection. 
...
%
As the maps do not overlap,  all encountered entities are unfamiliar at test time. %no entities are shared among the maps. 
