...
\includegraphics[width=\textwidth]{images/ZEST_text_similarities_differences_2 (6).png}}
 \caption{An illustration of textual similarity and visually relevant descriptions in birds' wiki articles: (1) we aim to leverage the similarity within %\gal{visually-relevant} \tzuf{no}
